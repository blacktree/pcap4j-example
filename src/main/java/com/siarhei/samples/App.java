...
public class App {
  ...
  public static void main(String[] args) throws PcapNativeException, NotOpenException {
    ...
    String filter = "tcp and host jsonplaceholder.typicode.com";
    ...
    PacketListener listener = new PacketListener() {
      ...
      public void gotPacket(Packet packet) {
        ...
        try {
          ...
          System.out.println(new String(Arrays.copyOfRange(rawData, 20, rawData.length), "UTF-8"));
        ...
        try {
          dumper.dump(tcpPacket, handle.getTimestamp());
